...
\subsection{Model}
\label{subs:3:sjmodel}

Berikut ini adalah seluruh \textit{model} pada SharIF Judge:
...
\textit{View} pada SharIF Judge terbagi menjadi beberapa kategori:
...
\label{subs:3:sjcontroller}

Berikut ini adalah seluruh \textit{controller} pada SharIF Judge:
...
\begin{itemize}
    ...
    \item Kirim jawaban \\  Melakukan \textit{submit} kode yang sudah dibuat pada editor.
\end{itemize}