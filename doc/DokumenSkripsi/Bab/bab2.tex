...
\begin{itemize}
    \item \verb|Ace| \\ Kelas utama yang digunakan mempersiapkan Ace pada browser. Salah satu fungsi yang dimiliki:
        \begin{itemize}
            \item \verb|edit(String | DOMElement el)| \\ \textit{Embed} Ace pada elemen yang disediakan.
        \end{itemize}
